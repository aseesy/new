...
export const agendaItems = [
  ...
  },
  {
    title: dates[1],
    data: [
      {hour: '4pm', duration: '1h', title: 'Meeting with Jhon'},
      {hour: '5pm', duration: '1h', title: 'Get together'}
    ]
  },
  {
    title: dates[2],
    data: [
      {hour: '1pm', duration: '1h', title: 'Some important event'},
  ...
  {
    title: dates[3],
    data: [{hour: '12am', duration: '1h', title: 'Some important event'}]
  },
  {
    title: dates[4],
    data: [{}]
